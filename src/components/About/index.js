      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Vinit Kumar Gole,</span> a Web
            Enthusiast
          </h3>
          <p
            ...
            data-aos={"fade-left"}
          >
            I love Gyming, Content Watching and playing games. I am
            currently pursuing BTech degree in Acropolis Institute Of Technology & Research. I am {getDate()}{" "}
